...
export const register = async (req, res) => {
    ...
    try {
        ...
        if(!name || !email || !password || !username)return res.status(400).json({message:"Please fill all fields"})
...
export const uploadProfilePicture = async (req,res)=>{
    ...
    try{
        ...
        await user.save();
        return res.json({message:"Profile picture upload successfully"})
...
export const updateUserProfile =async (req,res)=>{
    ...
    try{
        ...
        if(!user){
            return res.status(404).json({message:"3user not found"})
        }
...
export const getUserAndProfile = async (req, res) => {
    try{
        ...
        .populate('userId', 'name email username profilePicture');1
