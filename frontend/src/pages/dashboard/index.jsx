...
import { createPost, getAllPosts ,getAllComments,postComment} from '@/config/redux/action/postAction'
                  ...
                  return (
                    <div key={post._id} className={styles.singleCard}>
                     <div className={styles.singleCard_profileContainer}>
                        ...
                        <div className={styles.singleCard_profileDetails}>
                          <div>
                                    ...
                                    <div onClick={async ()=>{
                                      ...
                                      <div className={styles.singleCard_image}>
                                        {post.media !== "" ? (
                                          ...
                                          <div style={{width:"3.4rem", height:"auto"}}></div>
                                        )}
                                      </div>
                                      <div className={styles.optionsContainer}>
                                        <div onClick={async()=>{  await dispatch(incrementPostLike({post_id:post._id}))
                                    dispatch(getAllPosts())
