...
import { emptyMessage } from "@/config/redux/reducer/authReducer"; // adjust path if needed
...
<input  onChange={(e) =>setName(e.target.value)} className={styles.inputField}type="text" placeholder='Name' />        
      ...
      <input  onChange={(e) =>setEmailAddress(e.target.value)}  className={styles.inputField}type="text" placeholder='E-mail' />
   ...
   <div className={styles.cardContainer_right}>
        ...
        {userLoginMethod ? <p>Don't Hava an Account ?</p> : <p>Already Have an Account ?</p>}
